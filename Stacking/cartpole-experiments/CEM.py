...
for i in range(len(archs)):
    ...
    #Defining CEM Keras-RL agent: inputing the policy and the model
    model = CEMAgent(model=model, memory=memory,nb_actions=actions)
    #Compiling CEM with mean squared error loss
